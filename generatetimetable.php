    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <td style="text-align:center">WEEKDAYS</td>
                <td style="text-align:center">9:15-10:15</td>
                ...
                <td style="text-align:center">1:30-2:15</td>
                <td style="text-align:center">2:15-4:15</td>
                <td style="text-align:center">4:15-5:15</td>
            </tr>
            <tr>
                <?php
                $table = null;
                ...
                if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
                    ...
                    while ($row = mysqli_fetch_assoc($q)) {
                       ...
                       <td style=\"text-align:center\">Honors</td>
                       </tr>\n";
                    }

                    echo '</table>';
                    $sign = "GENERATED VIA LECTURE SCHEDULER";
...
<div align="center" style="margin-top: 10px">
    <button id="saveaspdf" class="btn btn-info btn-lg" onclick="printPage()">  PRINT This Page  </button>
    </div>
